...
if __name__ == '__main__':
  ...
  # load image
  img = np.array(io.imread(f'examples\\kitti\\image_2_custom\\{file_id}.png'), dtype=np.int32)

  # load labels
  with open(f'examples\\kitti\\label_2_custom\\{file_id}.txt', 'r') as f:
    labels = f.readlines()
  ...
  for line in labels:
    line = line.split()
    lab, _, _, _, _, _, _, _, h, w, l, x, y, z, rot, precision = line
